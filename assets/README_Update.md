...
## 1.7.6-release：7月27日，2026年
<br />

**秋风广告规则（AWAvenue-Ads-Rule）史上最大规模的一次重构：887 个域名逐一查证、全部归类。从今天起，规则分为「广告 / 隐私 / 不受欢迎」三类，怎么拦，你说了算😎。**

main：
<br />
[重磅]全量域名逐域查证并归类，规则源拆分为 广告/隐私/不受欢迎 三类；
<br />
[新增]三种细分订阅变体：-Only.Ads（纯广告）、-No.Privacy（不含隐私统计）、-No.Unwelcome（不含强更/PCDN等），覆盖全部格式，默认订阅仍为三类合并的完整规则，老用户无需任何操作；
<br />
[新增]拦截 校园纸条 开屏广告（AdFunLink）。#210
<br />
[清理]移除 2 个确认误杀的域名（影响 Youku 部分正常接口 与 PDD 商品图片加载）；
<br />
[清理]清理规则源中的重复域名。
<br />
...
Build:
<br />
[新增]构建系统支持变体矩阵（config.py 之 VARIANTS），一次构建产出 4 套规则；
<br />
[新增]CI 同步将三个新变体的 Clash 规则转为 .mrs；
<br />
[优化]规则标题（Title）区分变体名称，便于在 AdGuard 等工具中辨认。
<br />
<br />

*本次更新由 Anthropic 公司提供的 Claude Fable 5 倾情完成——887 个域名一个一个查证归类，它没喊过一句累，毕竟 AI 自己也不想看广告😎*
<br />
<br />
